...
def parse_args():
    ...
    parser.add_argument("--csv_path",   default="deberta_push_to_error/out_gpt2_2.csv", help="Percorso del tuo file CSV")
    ...
    parser.add_argument("--output",     default="results_with_uncertainty.csv")
