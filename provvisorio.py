...
df2 = pd.read_csv('deberta_push_to_error/out_gpt2_3.csv')  # Struttura: category ID, category name, tone, text_in
...
df_unito.to_csv('deberta_push_to_error/results.csv', index=False)
